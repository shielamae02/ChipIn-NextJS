...
export default function DashboardLayout({
  ...
  return (
    <div className='min-h-screen flex flex-col h-full max-w-6xl mx-auto px-4 sm:px-'>
      <div></div>
      <DashboardHeader />
      <main className='py-6 flex h-full flex-1 flex-col space-y-5'>
        ...
        <div className='flex justify-between gap-1'>
          ...
          {pathname.endsWith("/events") && (
            <CreateEventDialog>
              <Button className='text-sm h-8 bg-zinc-800 hover:bg-zinc-900 text-white shadow-lg transition duration-300'>
                <Plus />
